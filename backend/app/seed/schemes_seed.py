# Direct transcription of the 6 schemes in src/data/schemes.ts. Every
# field, rule, document list, and copy string is copied verbatim so the
# backend and frontend never drift from each other for demo purposes.
...
SCHEMES_DATA: list[dict[str, Any]] = [
    {
        "id": "nayi-disha",
        "name": "Nayi Disha Scholarship Support",
        "icon": "✦",
        "category": "Education",
        ...
        "requiredDocuments": ["identity", "income", "education", "enrollment"],
        "optionalDocuments": None,
        "preparationTime": "About 2–5 days",
        "nextSteps": [
            "Gather your education and income documents.",
            "Confirm the latest terms with the official provider.",
            "Apply through the relevant official channel.",
            "Save any acknowledgement or reference number.",
        ],
        "availability": "Demo availability: applications simulated",
        "privacyNote": "Only share documents with the official provider after you have verified the channel.",
    },
    {
        "id": "swasthya-saathi",
        "name": "Swasthya Saathi Family Care",
        "icon": "✚",
        "category": "Health",
        ...
        "requiredDocuments": ["identity", "address", "income", "referral"],
        "optionalDocuments": ["bank"],
        "preparationTime": "About 3–7 days",
        "nextSteps": [
            "Gather the documents you have.",
            "Ask the official provider about referral-card eligibility.",
            "Use the official channel if eligible.",
            "Keep the official acknowledgement safely.",
        ],
        "availability": "Demo availability: provider confirmation needed",
        "privacyNote": "Do not describe medical details in Sahaayak; discuss them only with an appropriate official provider.",
    },
    {
        "id": "kisan-sahayog",
        "name": "Kisan Sahayog Input Grant",
        "icon": "♧",
        "category": "Farming",
        ...
        "requiredDocuments": ["identity", "land", "bank"],
        "optionalDocuments": None,
        "preparationTime": "About 2–4 days",
        "nextSteps": [
            "Gather land and bank proof.",
            "Confirm the current local requirements.",
            "Submit only through the official channel.",
            "Save the acknowledgement number.",
        ],
        "availability": "Demo availability: seasonal example",
        "privacyNote": "Sahaayak never checks land records or account details.",
    },
    {
        "id": "udyam-shuru",
        "name": "Udyam Shuru Microbusiness Support",
        "icon": "↗",
        "category": "Work",
        ...
        "requiredDocuments": ["identity", "address", "income", "businessPlan"],
        "optionalDocuments": ["bank"],
        "preparationTime": "About 5–10 days",
        "nextSteps": [
            "Write a one-page business idea.",
            "Confirm eligibility with the official provider.",
            "Use the official channel to submit.",
            "Save the acknowledgement/reference number.",
        ],
        "availability": "Demo availability: orientation example",
        "privacyNote": "Do not enter sales, account, or business registration details here.",
    },
    {
        "id": "ghar-urja",
        "name": "Ghar Urja Clean-Cooking Support",
        "icon": "◒",
        "category": "Home",
        ...
        "optionalDocuments": None,
        "preparationTime": "About 2–6 days",
        "nextSteps": [
            "Check whether your household already has a connection.",
            "Confirm requirements with the official provider.",
            "Apply using the official channel if appropriate.",
            "Keep the acknowledgement/reference number.",
        ],
        "availability": "Demo availability: connection status must be confirmed",
        "privacyNote": "Sahaayak does not collect utility account numbers or visit your address.",
    },
    {
        "id": "kaushal-nayi-raah",
        "name": "Kaushal Nayi Raah Training Voucher",
        "icon": "◎",
        "category": "Skills",
        ...
        "optionalDocuments": ["education", "address"],
        "preparationTime": "About 1–3 days",
        "nextSteps": [
            "Choose a training area.",
            "Check the course and provider criteria.",
            "Apply through the official channel.",
            "Save your acknowledgement/reference number.",
        ],
        "availability": "Demo availability: course list is fictional",
        "privacyNote": "Choose a training provider only after independently confirming its credentials.",
    },
]


def seed_schemes() -> None:
    """Idempotent: does nothing if schemes already exist."""
    with Session(engine) as session:
        already_seeded = session.exec(select(Scheme)).first()
        if already_seeded:
            return
        for data in SCHEMES_DATA:
            session.add(
                Scheme(
                    ...
                    who_it_may_help=data["whoItMayHelp"],
